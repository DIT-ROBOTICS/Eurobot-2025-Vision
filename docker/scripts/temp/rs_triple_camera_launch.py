...
local_parameters = [{'name': 'camera_name1',       'default': 'cam_left',          'description': 'camera1 unique name'},
                    ...
                    {'name': 'serial_no1',         'default': os.environ.get('SERIAL_NO1', ''),     'description': 'camera1 serial number'},
                    {'name': 'serial_no2',         'default': os.environ.get('SERIAL_NO2', ''),     'description': 'camera2 serial number'},
                    {'name': 'serial_no3',         'default': os.environ.get('SERIAL_NO3', ''),    'description': 'camera3 serial number'},
