...
Dictionary Dictionary::loadPredefined(DICT_TYPES type)
{
  ...
  switch (type)
  {
    ...
    {
      vector<uint64_t> codes = {
        0xb532UL, 0x0f9aUL, 0x332dUL, 0x9946UL, 0x549eUL, 0x79cdUL, 0x9e2eUL, 0xc4f2UL, 
        0xfedaUL, 0xcf56UL, 0xf991UL, 0x11a7UL, 0x0eb7UL, 0x2a0fUL, 0x24b1UL, 0x263eUL, 
        0x4665UL, 0x6600UL, 0x6c5eUL, 0x76afUL, 0x868bUL, 0xb02bUL, 0xccd5UL, 0xdd82UL, 
        0xfe47UL, 0x9471UL, 0xace4UL, 0xa554UL, 0x2123UL, 0x346fUL, 0x4415UL, 0x57b2UL, 
        0x9ecfUL, 0xf0cbUL, 0x08aeUL, 0x0929UL, 0x1875UL, 0x04ffUL, 0x0df6UL, 0x1c5aUL,
        0x1718UL, 0x2a28UL, 0x328cUL, 0x38b2UL, 0x24e8UL, 0x2eebUL, 0x2d3fUL, 0x4b64UL, 
        0x502eUL, 0x5013UL
      };
      fromVector(codes, d._code_id);
      d._nbits = 16;
