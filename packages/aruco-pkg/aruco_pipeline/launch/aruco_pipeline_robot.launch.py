...
def load_config_and_create_node(context, *args, **kwargs):
    ...
    try:
        ...
        # Print pose topics
        blue_topic = node_parameters.get('blue_pose_topic', '/aruco/blue_pose')
        yellow_topic = node_parameters.get('yellow_pose_topic', '/aruco/yellow_pose')
    ...
    aruco_node = Node(
        ...
        executable='aruco_pipeline_robot',
        name='aruco_pipeline_robot',
        output='screen',
