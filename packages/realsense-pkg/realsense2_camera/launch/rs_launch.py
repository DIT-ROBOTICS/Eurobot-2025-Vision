...
configurable_parameters = [{'name': 'camera_name',                  'default': '', 'description': 'camera unique name'},
                           ...
                           {'name': 'rgb_camera.color_profile',     'default': '960,540,60', 'description': 'color stream profile'},
                           {'name': 'rgb_camera.color_format',      'default': 'BGR8', 'description': 'color stream format'},
                           {'name': 'rgb_camera.enable_auto_exposure', 'default': 'true', 'description': 'enable/disable auto exposure for color image'},
                           # Depth
                           {'name': 'enable_depth',                 'default': 'true', 'description': 'enable depth stream'},
                           {'name': 'depth_module.depth_profile',   'default': '848,480,30', 'description': 'depth stream profile'},
