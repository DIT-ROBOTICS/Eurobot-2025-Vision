...
class YoloNode(Node):
    def __init__(self):
        ...
        self.declare_parameter("color_topic", "/realsense2/cam_mid/color/image_raw")
        self.declare_parameter("depth_topic", "/realsense2/cam_mid/aligned_depth_to_color/image_raw")
