...
configurable_parameters = [{'name': 'camera_name',                  'default': 'D435', 'description': 'camera unique name'},
                           {'name': 'camera_namespace',             'default': 'cam1', 'description': 'namespace for camera'},
                           {'name': 'serial_no',                    'default': "_215322073247", 'description': 'choose device by serial number'},
